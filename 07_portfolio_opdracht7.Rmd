...
The gampminder data set was already in tidy data format, and therefor did not need to be edited. The dengue and flu data set did require editing to make the tables tidy. After making the data tidy, all data was stored in new CSV files. 
